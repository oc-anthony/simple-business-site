...
<head>
    ...
    <title>Opal - Admin Dashboard</title>
...
{{--                                    <a href="{{ route('user.logout') }}"> <i class="mdi mdi-logout"></i> Log Out </a>--}}
        ...
        <footer class="footer mt-auto">
            <div class="copyright bg-white">
                <p>
                    &copy; <span id="copy-year">2019</span> Copyright Opal Dashboard by
                    <a class="text-primary" href="http://www.iamabdus.com/" target="_blank">OC</a>.
                </p>
            </div>
            <script>
                var d = new Date();
